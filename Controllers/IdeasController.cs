                ...
                if(password != null){
                    ...
                    if (checkUser != null){
                        ...
                        if(0 != Hasher.VerifyHashedPassword(checkUser, checkUser.password, password)){
                            ...
                            ViewBag.LogErrors = "Email/Password do not match";
                            return View("Main");
                        }
                    }
                }
                else{
                    ViewBag.LogErrors = "Please input a password";
                    return  View("Main");
                }
                ViewBag.LogErrors = "Email not found. Register as a new user?";
                return  View("Main");
            }
            else{
                ViewBag.LogErrors = "Please input a valid email";
                return View("Main");
            }
        }
